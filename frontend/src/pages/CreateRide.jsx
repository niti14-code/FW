...
// College presets for pickup (only Bangalore engineering colleges)
const COLLEGE_PRESETS = [
  { label: 'RV College of Engineering', lat: 12.9215, lng: 77.4958 },
  { label: 'BMS College of Engineering', lat: 12.9611, lng: 77.5908 },
  { label: 'PES University', lat: 12.9345, lng: 77.5366 },
...
// City presets for drop location (any location)
const CITY_PRESETS = [
  { label: 'Bangalore', lat: 12.9716, lng: 77.5946 },
  { label: 'Hyderabad', lat: 17.3850, lng: 78.4867 },
  { label: 'Delhi', lat: 28.6139, lng: 77.2090 },
...
export default function CreateRide({ navigate }) {
  ...
  const validate = () => {
    ...
    // Validate pickup is from a Bangalore engineering college
    const pickupLabel = form.pickupLabel.toLowerCase();
    
    // List of valid Bangalore engineering colleges
    const validColleges = [
      ...
      'a m c e college of engineering',
      ...
      'h k e s s institute of technology',
      'sir m v institute of technology',
      'sri venkateshwara college of engineering',
      'd r college of engineering',
      'e s college of engineering',
      'g h college of engineering',
      'j n n college of engineering',
      'k l e college of engineering',
      'm v j college of engineering',
      'p e s college of engineering',
      'r v college of engineering',
      's g s institute of technology',
      's j c institute of technology',
      's r m institute of technology',
      'v t u college of engineering'
    ];
    
    const isBangaloreCollege = validColleges.some(college => 
      pickupLabel.includes(college) || college.includes(pickupLabel)
    );
    
    if (!isBangaloreCollege) {
